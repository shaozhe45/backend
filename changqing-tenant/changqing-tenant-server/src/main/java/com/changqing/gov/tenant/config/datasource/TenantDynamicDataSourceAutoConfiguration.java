 ...
 * AutoConfigureBefore： TenantDynamicDataSourceAutoConfiguration 将会在 DataSourceAutoConfiguration 类之前加载
...
public class TenantDynamicDataSourceAutoConfiguration extends DynamicDataSourceAutoConfiguration {
