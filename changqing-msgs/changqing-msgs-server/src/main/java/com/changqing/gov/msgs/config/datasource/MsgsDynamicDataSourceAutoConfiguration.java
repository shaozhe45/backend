package com.changqing.gov.msgs.config.datasource;
...
public class MsgsDynamicDataSourceAutoConfiguration extends DynamicDataSourceAutoConfiguration {

    public MsgsDynamicDataSourceAutoConfiguration(DynamicDataSourceProperties properties) {
        super(properties);
    }
