...
import com.changqing.gov.authority.dto.auth.RouterMeta;
import com.changqing.gov.authority.dto.auth.VueRouter;
...
import com.changqing.gov.utils.TreeUtil;
...
public class OauthMenuResourceController {
    ...
    private List<VueRouter> buildSuperAdminRouter() {
        ...
        tenant.setComponent("changqing/defaults/tenant/Index");
        ...
        globalUser.setComponent("changqing/defaults/globaluser/Index");
