 ...
 * 下面的每个注解讲解：
 * <p>
 * ConditionalOnProperty:  zuihou.database.multiTenantType=DATASOURCE 时，加载这个类，并执行下面的注解
...
@MapperScan(basePackages = { "com.changqing.gov", "com.changqing.gov" }, annotationClass = Repository.class)
public class GroupDynamicDataSourceAutoConfiguration extends DynamicDataSourceAutoConfiguration {

    public GroupDynamicDataSourceAutoConfiguration(DynamicDataSourceProperties properties) {
        super(properties);
    }
