package com.changqing.gov.order.controller.cloud;

import com.changqing.gov.base.R;
import com.changqing.gov.common.enums.DateType;
...
//        map.put("date", DateUtils.formatAsDateTime(new Date()));
        ...
        String url = "http://changqing-demo-server/restTemplate/get?key={key}";
//        String url = "http://changqing-demo-server/restTemplate/get?key={key}&date={date}&ldt={ldt}";
...
//        HttpEntity httpEntity = new HttpEntity(map);
    ...
    public R<RestTestDTO> post(@RequestParam("key") String key) {
        ...
        String url = "http://changqing-demo-server/restTemplate/post?key={key}";
    ...
    public R<RestTestDTO> post2(@RequestBody RestTestDTO order) {
        String url = "http://changqing-demo-server/restTemplate/post2";
