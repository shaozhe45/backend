package com.changqing.gov.order.config.datasource;
...
public class OrderDynamicDataSourceAutoConfiguration extends DynamicDataSourceAutoConfiguration {

    public OrderDynamicDataSourceAutoConfiguration(DynamicDataSourceProperties properties) {
        super(properties);
    }
