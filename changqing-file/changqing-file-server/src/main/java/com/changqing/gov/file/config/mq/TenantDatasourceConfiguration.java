package com.changqing.gov.file.config.mq;
...
public class TenantDatasourceConfiguration {
    ...
    public Binding dsQueueBinding() {
        return new Binding(BizMqQueue.TENANT_DS_QUEUE_BY_FILE, Binding.DestinationType.QUEUE, BizMqQueue.TENANT_DS_FANOUT_EXCHANGE_FILE, "", new HashMap(1));
    }
