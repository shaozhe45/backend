package com.changqing.gov.file.config.datasource;
...
public class FileDynamicDataSourceAutoConfiguration extends DynamicDataSourceAutoConfiguration {

    public FileDynamicDataSourceAutoConfiguration(DynamicDataSourceProperties properties) {
        super(properties);
    }
