...
@MapperScan(
        ...
        sqlSessionFactoryRef = ExecutorDatabaseAutoConfiguration.DATABASE_PREFIX + "SqlSessionFactory")
@EnableConfigurationProperties({MybatisPlusProperties.class})
@ConditionalOnExpression("!'DATASOURCE'.equals('${changqing.database.multiTenantType}')")
public class ExecutorDatabaseAutoConfiguration extends MasterDatabaseConfiguration {

    public ExecutorDatabaseAutoConfiguration(MybatisPlusProperties properties,
        ...
        log.debug("检测到 changqing.database.multiTenantType!=DATASOURCE，加载了 AuthorityDatabaseAutoConfiguration");
    }
