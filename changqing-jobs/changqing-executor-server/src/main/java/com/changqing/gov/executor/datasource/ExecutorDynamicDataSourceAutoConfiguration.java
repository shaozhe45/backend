...
public class ExecutorDynamicDataSourceAutoConfiguration extends DynamicDataSourceAutoConfiguration {

    public ExecutorDynamicDataSourceAutoConfiguration(DynamicDataSourceProperties properties) {
        super(properties);
    }
