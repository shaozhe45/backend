package com.changqing.gov.datasource;
...
@MapperScan(basePackages = {"com.changqing.gov", "com.xxl.job.admin.dao"}, annotationClass = Repository.class)
public class JobsDynamicDataSourceAutoConfiguration extends DynamicDataSourceAutoConfiguration {

    public JobsDynamicDataSourceAutoConfiguration(DynamicDataSourceProperties properties) {
        super(properties);
    }
