...
import com.changqing.gov.authority.entity.common.LoginLog;
...
import com.changqing.gov.authority.service.common.LoginLogService;
...
public class TestResource {
    ...
    public void testDict() {
        ...
        Collection<com.changqing.gov.authority.entity.common.Dictionary> dictionaryList = new ArrayList<>();
        dictionaryList.add(com.changqing.gov.authority.entity.common.Dictionary.builder().type("AAA").name("BBBB").build());
