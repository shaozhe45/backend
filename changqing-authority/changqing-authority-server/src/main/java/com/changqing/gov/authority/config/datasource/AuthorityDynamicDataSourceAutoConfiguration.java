package com.changqing.gov.authority.config.datasource;

import com.alibaba.druid.spring.boot.autoconfigure.DruidDataSourceAutoConfigure;
import com.baomidou.dynamic.datasource.spring.boot.autoconfigure.DynamicDataSourceCreatorAutoConfiguration;
import com.baomidou.dynamic.datasource.spring.boot.autoconfigure.DynamicDataSourceProperties;
import com.baomidou.dynamic.datasource.spring.boot.autoconfigure.druid.DruidDynamicDataSourceConfiguration;
import com.changqing.gov.database.datasource.DynamicDataSourceAutoConfiguration;
import com.changqing.gov.database.properties.DatabaseProperties;
import com.changqing.gov.tenant.context.InitDatabaseOnStarted;
import com.changqing.gov.tenant.strategy.impl.DatasourceInitSystemStrategy;
 ...
 * 下面的每个注解讲解：
 * <p>
 * ConditionalOnProperty:  changqing.database.multiTenantType=DATASOURCE 时，加载这个类，并执行下面的注解
 ...
 * MapperScan：扫描 com.changqing.gov 包下标记了Repository 注解的类为 Mybatis 的代理接口
 * <p>
 *
 * @author changqing
...
@MapperScan(basePackages = {"com.changqing.gov",}, annotationClass = Repository.class)
public class AuthorityDynamicDataSourceAutoConfiguration extends DynamicDataSourceAutoConfiguration {

    public AuthorityDynamicDataSourceAutoConfiguration(DynamicDataSourceProperties properties) {
        super(properties);
    }
