package com.changqing.gov.authority.entity.auth;
...
import static com.changqing.gov.common.constant.InjectionFieldConstants.ORG_ID_CLASS;
import static com.changqing.gov.common.constant.InjectionFieldConstants.ORG_ID_METHOD;
import static com.changqing.gov.common.constant.InjectionFieldConstants.STATION_ID_CLASS;
import static com.changqing.gov.common.constant.InjectionFieldConstants.STATION_ID_NAME_METHOD;
...
//    @Excel(name = "组织")
    ...
    @ApiModelProperty(value = "组织ID")
    @TableField(value = "org_id",exist = false)
//    @InjectionField(api = ORG_ID_CLASS, method = ORG_ID_METHOD, beanClass = Org.class)
    @Excel(name = "组织")
    @ExcelEntity(name = "")
    ...
    @Excel(name = "删除状态", replace = {"启用_true", "禁用_false", "_null"})
   ...
   // @Excel(name = "头像")
    ...
    public User(Long id, Long createUser, LocalDateTime createTime, Long updateUser, LocalDateTime updateTime,
                ...
                RemoteData<String, String> positionStatus, String workDescribe, LocalDateTime passwordErrorLastTime, Integer passwordErrorNum, LocalDateTime passwordExpireTime, String password,
                LocalDateTime lastLoginTime,Boolean isDelete) {
        this.id = id;
