package com.changqing.gov.zuul.filter.pre;

import cn.hutool.core.util.StrUtil;
import com.changqing.gov.utils.StrPool;
import com.changqing.gov.zuul.filter.BaseFilter;
 ...
 * <p>
 * 使用场景:
 * 用户changqing，在启动 changqing-authority-server 时， 将改成 spring.application.name: changqing-authority-server-changqing ，
 * 通过在请求每个请求头中增加 serviceSuffix=changqing , 请求就能通过网关路由到 changqing 的机器上
 * <p>
 * 该过滤器请勿使用在正式环境
 *
 * @author changqing
