package com.changqing.gov.zuul.config;

import com.alibaba.fastjson.JSONArray;
import com.changqing.gov.swagger2.SwaggerProperties;
    ...
    public List<SwaggerResource> get() {
        ...
        for (Route route : routes) {
            ...
            try {
                ...
                // 访问地址： http://changqing-test-server/swagger-resources  （其中 changqing-test-server 必须是服务的注册到nacos中的名称，否则无法调用成功 ）
