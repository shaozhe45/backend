...
public class GatewayDatabaseAutoConfiguration extends MasterDatabaseConfiguration {

    public GatewayDatabaseAutoConfiguration(MybatisPlusProperties properties,
