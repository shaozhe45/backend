...
public class TaskHiReimbursementResDTO extends TaskHiResDTO {
    ...
    @Builder
    public TaskHiReimbursementResDTO(String id, String name, String assignee, String tenantId, Boolean isSuspended, String taskDefKey, RemoteData<String, ProcessInstanceResDTO> inst, RemoteData<String, BizReimbursement> biz, RemoteData<String, BizItem> item, RemoteData<String, BizLeave> biz1) {
        this.id = id;
        this.name = name;
