...
public class ActivitiDatabaseAutoConfiguration extends MasterDatabaseConfiguration {

    public ActivitiDatabaseAutoConfiguration(MybatisPlusProperties properties,
